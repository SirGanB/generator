...
class DraconatosNegro extends Draconatos {
  DraconatosNegro() {
    ...
    tracosRaciais.addAll([
      ...
      Habilidade(
        descricao: "Você possui resistência ao tipo de dano Acido.",
        nivelDesbloqueio: 0,
