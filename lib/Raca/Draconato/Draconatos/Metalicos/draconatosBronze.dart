...
class DraconatosBronze extends Draconatos {
  DraconatosBronze() {
    ...
    tracosRaciais.addAll([
      ...
      Habilidade(
        descricao: "Você possui resistência ao tipo de dano Elétrico.",
        nivelDesbloqueio: 0,
